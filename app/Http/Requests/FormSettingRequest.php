...
class FormSettingRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'level_classic_seller_percent'   => $this->type == 'bonus_classic' ? 'required|integer' : 'nullable',
    ...
    public function messages()
    {
        return [
            ...
            'level_classic_seller_percent.required' => 'El valor es requerido',
            'level_classic_seller_percent.integer' => 'El valor debe ser numerico.',
