...
class FormSettingRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'register'              => $this->type == 'bonus' ? 'required|numeric|between:0.0,100' : 'nullable',
            'referrals'             => $this->type == 'bonus' ? 'required|numeric|between:0.0,100' : 'nullable',
            'to_access'             => $this->type == 'bonus' ? 'required|numeric|between:0.0,100' : 'nullable',
            'user_to_seller'        => $this->type == 'bonus' ? 'required|numeric|between:0.0,100' : 'nullable',
            'diary'                 => $this->type == 'bonus' ? 'required|numeric|between:0.0,100' : 'nullable',
    ...
    public function messages()
    {
        return [
            ...
            'register.numeric'   => 'El valor del jib debe ser numerico.',
            'referrals.numeric'  => 'El valor del jib debe ser numerico.',
            'to_access.numeric'  => 'El valor del jib debe ser numerico.',
            'register.between'   => 'El valor del jib de cambio debe tener un formato en 0.00.',
            'referrals.between'  => 'El valor del jib de cambio debe tener un formato en 0.00.',
            'to_access.between'  => 'El valor del jib de cambio debe tener un formato en 0.00.',
