...
<![endif]-->
  ...
  <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="23308eb9-3685-43e8-9470-799f5caf5f3f" data-mc-module-version="2019-10-22">
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 0px 0px; line-height:22px; text-align:inherit; background-color:#FFFFFF;" height="100%" valign="top" bgcolor="#FFFFFF" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 16px">Te damos la bienvenida a Jimbo Sorteos, donde todos ganan!</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 20px 40px 20px; line-height:22px; text-align:inherit; background-color:#FFFFFF;" height="100%" valign="top" bgcolor="#FFFFFF" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 16px">Te has resgistrado de manera exitosa en nuestra plataforma, esperamos que ganas con lo mejor APP! del mercado. Jimbo sorteos responsabilidad y seriedad en todos sus servicios.</span><br>
<span style="font-size: 18px"><strong>Gracias por preferirnos</strong></span>.</div><div></div></div></td>
      </tr>
    </tbody>
