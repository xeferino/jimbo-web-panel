...
@section('page-content')
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            <form method="POST" action="{{ route('panel.sliders.store') }}" name="form-slider-create" id="form-slider-create" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                    <div class="col-sm-12">
                        <img src="{{asset('assets/images/sliders/slider.png')}}" style= "margin: 0px 0 5px 0;" width="50px" height="50px" alt="avatar" id="slider">
                        <br>
                ...
                <div class="col-md-12 text-right">
                    ...
                    <button type="submit" class="btn btn-warning  btn-slider">Registrar</button>
                </div>
