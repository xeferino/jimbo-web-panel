...
@section('page-content')
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            <form method="POST" action="{{ route('panel.countries.update', ['country' => $country->id]) }}" name="form-country-edit" id="form-country-edit" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group row">
                    <div class="col-sm-12">
                        <img src="{{ $country->img != 'flag.png' ? asset('assets/images/flags/'.$country->img): asset('assets/images/flags/flag.png') }}" style= "margin: 0px 0 5px 0;" width="50px" height="50px" alt="avatar" id="avatar" class="img-radius">
                        <br>
                    ...
                    <div class="col-sm-6">
                        ...
                        <select name="active" id="active" class="form-control">
                            <option value="1" @if ($country->active === 1) selected @endif>Activo</option>
                            <option value="0" @if ($country->active === 0) selected @endif>Inactivo</option>
                        </select>
                ...
                <div class="col-md-12 text-right">
                    ...
                    <button type="submit" class="btn btn-warning  btn-country">Actualizar</button>
                </div>
