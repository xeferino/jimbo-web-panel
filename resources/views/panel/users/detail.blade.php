@extends('layouts.app', ['title' => $title ?? 'Usuarios - Detalle'])
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>Informacion del detalle del usuario en el sistema.</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="card fb-card">
            <div class="card-block text-center">
                <div class="row">
                    ...
                    <div class="col-6 b-r-default">
                        <h6><b>{{ $user->Department->name }}</b></h6>
                        <p class="text-muted">Departamento</p>
                    </div>
                    <div class="col-6">
                        <h6><b>{{ ($user->active) ? 'Activo' : 'Inactivo' }}</b></h6>
                        <p class="text-muted">Estatus</p>
                    </div>
                    <div class="col-12">
                        <br>
                        <div class="alert alert-info" role="alert"><b>Permisos en el sistema del role {{ $user->getRoleNames()->join('') }}</b></div>
                    </div>
