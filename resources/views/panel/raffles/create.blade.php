            ...
            <form method="POST" action="{{ route('panel.raffles.store') }}" name="form-raffle-create" id="form-raffle-create">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="number" name="prize_1" id="prize_1" value="100" min="100" max="100" class="form-control">
                        <div class="col-form-label has-danger-prize_1"></div>
                    </div>

                    <div class="col-sm-3">
                        <label class="col-form-label">2° (%)</label>
                        <input type="number" name="prize_2" id="prize_2" value="20" min="1" max="100" class="form-control">
                        <div class="col-form-label has-danger-prize_2"></div>
                    </div>

                    <div class="col-sm-3">
                        <label class="col-form-label">3° (%)</label>
                        <input type="number" name="prize_3" id="prize_3" value="0.6" min="0.6" max="100" class="form-control">
                        <div class="col-form-label has-danger-prize_3"></div>
                    </div>

                    <div class="col-sm-3">
                        <label class="col-form-label">4° (%)</label>
                        <input type="number" name="prize_4" id="prize_4" value="0.6" min="0.6" max="100" class="form-control">
                        <div class="col-form-label has-danger-prize_4"></div>
                    </div>

                    <div class="col-sm-2">
                        <label class="col-form-label">5° (%)</label>
                        <input type="number" name="prize_5" id="prize_5" value="0.6" min="0.6" max="100" class="form-control">
                        <div class="col-form-label has-danger-prize_5"></div>
                    </div>

                    <div class="col-sm-2">
                        <label class="col-form-label">6° (%)</label>
                        <input type="number" name="prize_6" id="prize_6" value="0.6" min="0.6" max="100" class="form-control">
                        <div class="col-form-label has-danger-prize_6"></div>
                    </div>

                    <div class="col-sm-2">
                        <label class="col-form-label">7° (%)</label>
                        <input type="number" name="prize_7" id="prize_7" value="0.6" min="0.6" max="100" class="form-control">
                        <div class="col-form-label has-danger-prize_7"></div>
                    </div>

                    <div class="col-sm-2">
                        <label class="col-form-label">8° (%)</label>
                        <input type="number" name="prize_8" id="prize_8" value="0.6" min="0.6" max="100" class="form-control">
                        <div class="col-form-label has-danger-prize_8"></div>
                    </div>

                    <div class="col-sm-2">
                        <label class="col-form-label">9° (%)</label>
                        <input type="number" name="prize_9" id="prize_9" value="0.6" min="0.6" max="100" class="form-control">
                        <div class="col-form-label has-danger-prize_9"></div>
                    </div>

                    <div class="col-sm-2">
                        <label class="col-form-label">10° (%)</label>
                        <input type="number" name="prize_10" id="prize_10" value="0.6" min="0.6" max="100" class="form-control">
