...
<head>
  ...
  <title>Jimbo Sorteos - Preguntas frecuentes</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="{{route('landing.faqs')}}">Preguntas frecuentes</a></li>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="{{route('landing.rules_game')}}">Reglas del juego</a></li>
            </ul>
          </div>
